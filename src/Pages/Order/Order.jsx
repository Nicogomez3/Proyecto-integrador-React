...
const Order = () => {
  ...
  return (
    <Box  as="section" mt="120px" mb="60px" width="100%" display="flex" flexDirection="column" justifyContent="center" alignItems="center" >
        <Heading as="h2" fontSize="2xl" bg="#2d5356" color="white" width="750px" textAlign="left" p="20px" borderTopLeftRadius={20} borderTopRightRadius={20}>
            Detalles de la orden
        </Heading>
        <Box display="flex" flexDirection="column" bg="#f7f7f7" justifyContent="center" alignItems="center" width="750px" p="20px" borderBottomLeftRadius={20} borderBottomRightRadius={20}>
          <Box display="flex" justifyContent="space-between" width="600px" p="20px"> 
        ...
        <Heading as="h2" fontSize="2xl" bg="#2d5356" color="white" width="750px" textAlign="left" p="20px" borderTopLeftRadius={20} borderTopRightRadius={20} mt="20px">Detalles de la compra</Heading>
        <Box display="flex" flexDirection="column" bg="#f7f7f7" justifyContent="center" alignItems="center" width="750px" p="20px" borderBottomLeftRadius={20} borderBottomRightRadius={20}>
        ...
        <Heading as="h2" fontSize="2xl" bg="#2d5356" color="white" width="750px" textAlign="left" p="20px" borderTopLeftRadius={20} borderTopRightRadius={20} mt="20px">Detalles del comprador</Heading>
        <Box display="flex" flexDirection="column" bg="#f7f7f7" justifyContent="center" alignItems="center" width="750px" p="20px" borderBottomLeftRadius={20} borderBottomRightRadius={20}>
          <Box display="flex" justifyContent="space-between" width="600px" p="20px">
            <Text>Nombre:</Text>
