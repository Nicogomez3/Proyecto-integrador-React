...
const Support = () => {
  return (
    <>
        <Container display="flex" flexDirection={{base:"column", xl:"row"}}  alignItems="center" justifyContent="space-evenly" p="60px" maxWidth="100%" marginInlineStart="20px" marginInlineEnd="20px" width="100%" >
